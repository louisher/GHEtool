...
def testCustomDatafile():
    ...
    for i in (1, 2, 3, 4):
        ...
        assert abs(1-borefield.H/correctAnswers[i - 1])<=0.008


if __name__ == "__main__":

    testCases()  # check different cases
    testCustomDatafile()  # check if the custom datafile is correct
